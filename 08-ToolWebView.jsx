...
export default function ToolWebView({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-md animate-fade-in">
      ...
      {/* WebView Container */}
      <div className="relative z-10 w-full h-full max-w-7xl max-h-[90vh] rounded-3xl overflow-hidden bg-white/95 backdrop-blur-2xl border border-white/40 shadow-2xl flex flex-col animate-scale-in">
