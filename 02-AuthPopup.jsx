    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in">
      ...
      <div className="relative w-full max-w-md rounded-[32px] border border-white/20 bg-white/80 backdrop-blur-2xl shadow-2xl p-8 animate-scale-in">
        ...
        <div className="space-y-3 mb-6">
          {/* Google */}
          <button className="w-full py-3.5 px-4 rounded-xl bg-white/80 backdrop-blur-md border border-gray-200/50 hover:bg-white hover:shadow-md transition-all flex items-center justify-center gap-3">
          ...
          {/* Apple */}
          <button className="w-full py-3.5 px-4 rounded-xl bg-gray-900 hover:bg-gray-800 transition-all flex items-center justify-center gap-3">
        ...
        <div className="space-y-3">
          ...
          <button className="w-full py-3.5 px-4 rounded-xl bg-gray-900 hover:bg-gray-800 text-white font-medium text-sm transition-all shadow-lg hover:shadow-xl">
