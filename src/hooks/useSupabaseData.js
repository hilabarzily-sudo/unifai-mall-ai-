...
import { transformTools } from '../utils/dataTransformers'
  ...
  useEffect(() => {
    ...
    async function fetchHistory() {
      ...
      if (err) {
        ...
        // Transform tools to include all necessary fields (url, etc.)
        const transformedTools = transformTools(data)
        setRecentTools(transformedTools || [])
      }
      setLoading(false)
    }
    fetchHistory()
